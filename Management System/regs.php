        ...
        <div class="row" style="margin: 1cm;">
            <div class="col-md-6 col-md-offset-3">
                <div class="panel panel-primary">
                    <div class="panel-heading">AMBASSADORS REGISTRATION</div>
                    <div class="panel-body">
                        
                        <form role="form" method="post" action="regs.php" accept-charset="UTF-8">
...
require 'dbConn.php';
$conn = Connect();
if(isset($_POST['name']) &&isset($_POST['phone'])&& isset($_POST['email'])&& isset($_POST['gender'])&& isset($_POST['univ'])){
$name = $_POST["name"];
$contact = $_POST["phone"];
$email = $_POST["email"];
$gender = $_POST["gender"];
$uni = $_POST["univ"];
$query   = "INSERT into amb_reg (rName,rEmail,rPhone,rGender , rUni) VALUES('" . $name . "','" . $email . "','" . $contact . "','" . $gender . "','" . $uni . "')";
